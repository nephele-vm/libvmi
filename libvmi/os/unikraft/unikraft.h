...
status_t unikraft_symbol_to_address(vmi_instance_t instance,
                                   const char *symbol, addr_t *__unused, addr_t *address);

char* unikraft_system_map_address_to_symbol(vmi_instance_t vmi, addr_t address,
        const access_context_t *ctx);

status_t unikraft_pid_to_pgd(vmi_instance_t vmi, vmi_pid_t pid, addr_t *dtb);

status_t unikraft_pgd_to_pid(vmi_instance_t vmi, addr_t pgd, vmi_pid_t *pid);
